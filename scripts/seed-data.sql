...
INSERT OR IGNORE INTO groups (id, name, description, load_balance_strategy, enabled)
VALUES ('group-default', 'default', 'Default group', 'round_robin', 1);

INSERT OR IGNORE INTO providers (id, name, base_url, status, supported_formats, endpoints)
VALUES 
...
INSERT OR IGNORE INTO models (id, name, display_name, model_type, context_window, max_output_tokens, enabled)
VALUES
...
INSERT OR IGNORE INTO api_keys (id, key_hash, key_prefix, name, group_id, status)
